...
#include "ui_controlpanel_0.h"

ControlPanel_0::ControlPanel_0(QWidget *parent)
    : ControlPanel(parent)
    , ui(new Ui::ControlPanel_0)
{
    ui->setupUi(this);
    ...
    foreach(auto each, btnErrors)
        connect(each, &QPushButton::clicked, this, &ControlPanel_0::slotButtonsError);
    ...
    foreach(auto each, leRates)
        connect(each, &QLineEdit::editingFinished, this, &ControlPanel_0::slotEditRate);
...
ControlPanel_0::~ControlPanel_0()
{
    delete ui;
}

void ControlPanel_0::setData(int id, QJsonObject _obj)
{
    obj = _obj;
...
void ControlPanel_0::calculateRate1()
{
...
void ControlPanel_0::slotButtonsError(bool check)
{
...
void ControlPanel_0::slotEditRate()
{
