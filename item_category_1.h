#ifndef ITEM_CATEGORY_1_____H
#define ITEM_CATEGORY_1_____H
...
class Item_category_1 : public QGraphicsObject
{
    Q_OBJECT
public:
    Item_category_1(QJsonArray*);
    int getHeight(void);
    void clearWorkFlags(void){workFlag = false;}
