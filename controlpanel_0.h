#ifndef CONTROLPANEL_0____H
#define CONTROLPANEL_0____H
...
namespace Ui {
class ControlPanel_0;
}

class ControlPanel_0 : public ControlPanel
{
    Q_OBJECT

public:
    explicit ControlPanel_0(QWidget *parent = nullptr);
    ~ControlPanel_0();
    virtual void setData(int, QJsonObject);

private:
    Ui::ControlPanel_0 *ui;
